    ...
    return (
      <main className="grid-overlay min-h-screen px-6 py-10">
        <div className="mx-auto max-w-4xl">
          <Card className="p-8">
            <div className="text-xs font-black uppercase tracking-[0.22em] text-[#e7ff9a]">Campaign production</div>
            <h1 className="mt-3 font-display text-5xl leading-tight text-[#fbfbf7]">
